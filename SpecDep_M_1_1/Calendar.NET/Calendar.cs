...
namespace Calendar.NET
{
    ...
    public class Calendar : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._btnToday.ButtonText = "Сегодня";
            ...
            this._btnLeft.ButtonText = "Предыдущий месяц";
            ...
            this._btnLeft.Size = new System.Drawing.Size(162, 29);
            ...
            this._btnRight.ButtonText = "Следующий месяц";
            ...
            this._btnRight.Location = new System.Drawing.Point(258, 20);
            this._btnRight.Name = "_btnRight";
            this._btnRight.Size = new System.Drawing.Size(162, 29);
        ...
        private void CalendarMouseClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left && AllowEditingEvents)
            {
                if (_calendarView == CalendarViews.Month)
                {
                    foreach(CalendarEvent r in _calendarEvents)
                    {
                        //изменено мной
                        r.Event.EventColor = Color.SkyBlue;
                    }
                    ...
                    for (int i = 0; i < num; i++)
                    {
                        ...
                        {
                            data = _calendarEvents[i].Date;
                            data_to_view = data.ToString("d");
                            _calendarEvents[i].Event.EventColor = Color.Green;
                            selected_date = _calendarEvents[i].Date.ToString("d");
        ...
        private void RenderMonthCalendar(PaintEventArgs e)
        {
            ...
            g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAliasGridFit;
            SizeF sunSize = g.MeasureString("Пн", _dayOfWeekFont);
            SizeF monSize = g.MeasureString("Вт", _dayOfWeekFont);
            SizeF tueSize = g.MeasureString("Ср", _dayOfWeekFont);
            SizeF wedSize = g.MeasureString("Чт", _dayOfWeekFont);
            SizeF thuSize = g.MeasureString("Пт", _dayOfWeekFont);
            SizeF friSize = g.MeasureString("Сб", _dayOfWeekFont);
            SizeF satSize = g.MeasureString("Вс", _dayOfWeekFont);
            SizeF dateHeaderSize = g.MeasureString(
